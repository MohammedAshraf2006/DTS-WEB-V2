...
| 03 | [wave-03-pages-routes.md](wave-03-pages-routes.md) | done | Products + services + clients routes shipped |
...
- **Routes:** `/`, `/products`, `/products/ess|ers|esa`, `/services`, `/services/signature`, `/clients`, `/contact`, 404
