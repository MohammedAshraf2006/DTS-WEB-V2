...
See [`plans/status.md`](../plans/status.md). As of 2026-08-14: foundation **done**; Home **in progress** (partners/clients); products routes **shipped**; `/contact` **shipped**; `/services` still open.
